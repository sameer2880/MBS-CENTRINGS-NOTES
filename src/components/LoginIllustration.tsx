...
export function LoginIllustration({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* ground shadow */}
      <ellipse cx="118" cy="250" rx="70" ry="9" fill="url(#li-ground)" />

      {/* legs */}
      <rect x="99" y="188" width="17" height="52" rx="8.5" fill="url(#li-pants)" />
      <rect x="124" y="188" width="17" height="52" rx="8.5" fill="url(#li-pants)" />
      ...
      <rect x="90" y="118" width="58" height="78" rx="19" fill="url(#li-vest)" />
      {/* belt */}
      ...
      <rect x="76" y="126" width="17" height="56" rx="8.5" fill="url(#li-sleeve)" />
      <circle cx="84" cy="187" r="9.5" fill="url(#li-skin)" />

      {/* raised arm holding the phone — forearm overlaps the upper arm at the elbow */}
      <rect x="139" y="116" width="44" height="17" rx="8.5" fill="url(#li-sleeve)" />
      <rect x="139" y="127" width="17" height="40" rx="8.5" fill="url(#li-sleeve)" />
      {/* sleeve cuff */}
      <rect x="139" y="160" width="17" height="7" rx="3.5" fill="#22324a" opacity="0.5" />

      {/* neck — bridges head and torso */}
      <rect x="111" y="108" width="17" height="15" fill="url(#li-skin)" />
      <rect x="111" y="116" width="17" height="7" fill="#c99368" opacity="0.5" />

      {/* head + hard hat, dome overlaps down onto the head */}
      <circle cx="119" cy="94" r="21" fill="url(#li-skin)" />
      {/* ear */}
      ...
      <ellipse cx="119" cy="78" rx="25" ry="15" fill="url(#li-hat)" />
      ...
      <rect x="149" y="29" width="66" height="108" rx="12" fill="url(#li-phone)" stroke="#d7e2cd" strokeWidth="1.5" />
      {/* speaker notch */}
      ...
      <rect x="161" y="117" width="6" height="9" rx="1.5" fill="url(#li-bar)" />
      <rect x="171" y="111" width="6" height="15" rx="1.5" fill="url(#li-bar)" />
      ...
      <circle cx="181" cy="128" r="10.5" fill="url(#li-skin)" />
      <path d="M174 128 q7 6 14 0" stroke="#c99368" strokeWidth="2" opacity="0.4" fill="none" strokeLinecap="round" />
    </svg>
  );
}